...
namespace EmployeeManagement.Test
{
    ...
    public class EmployeeServiceTests //:  IClassFixture<EmployeeServiceFixture>
    {
        ...
        public void CreateInternalEmployee_InternalEmployeeCreated_MustHaveAttendedFirstObligatoryCourse_WithObject()
        {
            ...
            var ObligatoryCourse = _employeeServiceFixture.EmployeeManagementTestDataRepository.GetCourse(new Guid("37e03ca7-c730-4351-834c-b66f280cdb01"));
        ...
        [Fact]
        public void CreateInternalEmployee_InternalEmployeeCreated_MustHaveAttendedFirstObligatoryCourse_WithPrdicate()
        {
        ...
        public void CreateInternalEmployee_InternalEmployeeCreated_AttendedCoursesMustNotBeNew()
        {
            ...
            Assert.All(internalEmployee.AttendedCourses, course =>
            {
